...
SELECT id, code, name, time_per_session, sessions_per_week, total_sessions, min_pass_grade, min_attendance, image_link, status, description, created_by, updated_by, created_at, updated_at, learner_type
FROM subjects
